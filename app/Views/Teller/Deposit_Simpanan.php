  ...
  <section class="content">
      <div class="container-fluid">
          <form action="../Models/Teller/Deposit_Simpanan.php" method="post" enctype="multipart/form-data">
              <div class="card card-default">
                  ...
                  <div class="card-footer">
                      <button type="submit" name="deposit_simpanan" value="Simpan" class="btn btn-primary">Simpan</button>
                  </div>
              </div>
          </form>
      </div><!-- /.container-fluid -->
